<?php echo form_open_multipart('admin/agency/insert'); ?>
<div class="content-wrapper">
	<form action="<?php echo base_url() ?>admin/agency/insert.html" enctype="multipart/form-data" method="POST" accept-charset="utf-8">
		<section class="content-header">
			<h1><i class="glyphicon glyphicon-text-background"></i> Thêm đối tác mới</h1>
		</section>
		<!-- Main content -->
